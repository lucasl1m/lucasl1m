...
function TimelineCard({ entry }: { entry: ExperienceEntry }) {
  ...
  return (
    <motion.article
      ...
      className="relative flex gap-6 pl-8 sm:pl-10 before:absolute before:left-[7px] sm:before:left-[9px] before:top-6 before:bottom-0 before:w-px before:bg-border last:before:hidden mb-10 last:mb-0"
    >
      <span
